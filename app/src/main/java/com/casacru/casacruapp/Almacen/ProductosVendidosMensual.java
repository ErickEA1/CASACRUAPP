...
public class ProductosVendidosMensual extends AppCompatActivity implements IProductosMensual {
                    ...
                    if(anio != null) {
                        ...
                        if(anio!="*SELECCIONA UN AÑO*"){
                            if(chdengui2.isChecked() || chNopala2.isChecked() || chSD2.isChecked() || chMR2.isChecked() || chLagunas2.isChecked() || ch612.isChecked()){
                                new IntentIntegrator(ProductosVendidosMensual.this).initiateScan();
                            }else{
               ...
               String id61=consultarIdProducto(conexion61());
                if(chdengui2.isChecked()){
                    new TareaProductosMensual(ene, feb, mar, abr, may, jun, jul, ago, sep, oct, nov, dec, conexion2(),
                       ProductosVendidosMensual.this).execute(idDengui,"3","33","1",anio);
                    new TareaProductosMensual(ene, feb, mar, abr, may, jun, jul, ago, sep, oct, nov, dec, conexion2(),
                            ProductosVendidosMensual.this).execute(idDengui,"3","33","11",anio);
                }
                if(chNopala2.isChecked()){
                    new TareaProductosMensual(ene, feb, mar, abr, may, jun, jul, ago, sep, oct, nov, dec, conexion2(),
                            ProductosVendidosMensual.this).execute(idDengui,"3140", "3142","12",anio);
                } if(chLagunas2.isChecked()){
                    new TareaProductosMensual(ene, feb, mar, abr, may, jun, jul, ago, sep, oct, nov, dec, conexionLagunas(),
                            ProductosVendidosMensual.this).
                            execute(idLagunas,"3", "3050","4",anio);
                } if(chMR2.isChecked()){
                    new TareaProductosMensual(ene, feb, mar, abr, may, jun, jul, ago, sep, oct, nov, dec, conexionLagunas(),
                            ProductosVendidosMensual.this).
                            execute(idLagunas,"3077", "3078","10",anio);
                } if(ch612.isChecked()){
                    new TareaProductosMensual(ene, feb, mar, abr, may, jun, jul, ago, sep, oct, nov, dec, conexion61(),
                            ProductosVendidosMensual.this).
                            execute(id61,"3", "3043","1",anio);
                } if (chSD2.isChecked()){
                    new TareaProductosMensual(ene, feb, mar, abr, may, jun, jul, ago, sep, oct, nov, dec, ConexionSD(),
                            ProductosVendidosMensual.this).
                            execute(idSD,"3", "3050","4",anio);
                }
                Datasets();
                Promedio();
                CustomGraphic();
...
public void Datasets(){
    ...
    public void consultasDengui(){
        consultarIdProducto(conexion2());
        Consulta1(conexion2(),IdProducto,"1","3", "3056");
        Consulta2(conexion2(),IdProducto,"1","3", "3056");
        Consulta3(conexion2(),IdProducto,"1","3", "3056");
        Consulta4(conexion2(),IdProducto,"1","3", "3056");
        Consulta5(conexion2(),IdProducto,"1","3", "3056");
        Consulta6(conexion2(),IdProducto,"1","3", "3056");
        Consulta7(conexion2(),IdProducto,"1","3", "3056");
        Consulta8(conexion2(),IdProducto,"1","3", "3056");
        Consulta9(conexion2(),IdProducto,"1","3", "3056");
        Consulta10(conexion2(),IdProducto,"1","3", "3056");
        Consulta11(conexion2(),IdProducto,"1","3", "3056");
        Consulta12(conexion2(),IdProducto,"1","3", "3056");

    }
    public void consultasNopala(){
        Consulta1(conexion2(),IdProducto,"12","3140", "3142");
        Consulta2(conexion2(),IdProducto,"12","3140", "3142");
        Consulta3(conexion2(),IdProducto,"12","3140", "3142");
        Consulta4(conexion2(),IdProducto,"12","3140", "3142");
        Consulta5(conexion2(),IdProducto,"12","3140", "3142");
        Consulta6(conexion2(),IdProducto,"12","3140", "3142");
        Consulta7(conexion2(),IdProducto,"12","3140", "3142");
        Consulta8(conexion2(),IdProducto,"12","3140", "3142");
        Consulta9(conexion2(),IdProducto,"12","3140", "3142");
        Consulta10(conexion2(),IdProducto,"12","3140", "3142");
        Consulta11(conexion2(),IdProducto,"12","3140", "3142");
        Consulta12(conexion2(),IdProducto,"12","3140", "3142");
    }
    public void ConsultasTienda61(){
        consultarIdProducto(conexion61());
        Consulta1(conexion61(),IdProducto,"1","3", "3043");
        Consulta2(conexion61(),IdProducto,"1","3", "3043");
        Consulta3(conexion61(),IdProducto,"1","3", "3043");
        Consulta4(conexion61(),IdProducto,"1","3", "3043");
        Consulta5(conexion61(),IdProducto,"1","3", "3043");
        Consulta6(conexion61(),IdProducto,"1","3", "3043");
        Consulta7(conexion61(),IdProducto,"1","3", "3043");
        Consulta8(conexion61(),IdProducto,"1","3", "3043");
        Consulta9(conexion61(),IdProducto,"1","3", "3043");
        Consulta10(conexion61(),IdProducto,"1","3", "3043");
        Consulta11(conexion61(),IdProducto,"1","3", "3043");
        Consulta12(conexion61(),IdProducto,"1","3", "3043");

    }
    public void ConsultasTiendaDengui(){
        consultarIdProducto(conexion2());
        Consulta1(conexion2(),IdProducto,"11","3", "3056");
        Consulta2(conexion2(),IdProducto,"11","3", "3056");
        Consulta3(conexion2(),IdProducto,"11","3", "3056");
        Consulta4(conexion2(),IdProducto,"11","3", "3056");
        Consulta5(conexion2(),IdProducto,"11","3", "3056");
        Consulta6(conexion2(),IdProducto,"11","3", "3056");
        Consulta7(conexion2(),IdProducto,"11","3", "3056");
        Consulta8(conexion2(),IdProducto,"11","3", "3056");
        Consulta9(conexion2(),IdProducto,"11","3", "3056");
        Consulta10(conexion2(),IdProducto,"11","3", "3056");
        Consulta11(conexion2(),IdProducto,"11","3", "3056");
        Consulta12(conexion2(),IdProducto,"11","3", "3056");
    }
    public void ConsultasLagunas(){
        consultarIdProducto(conexionLagunas());
        Consulta1(conexionLagunas(),IdProducto,"4","3", "3050");
        Consulta2(conexionLagunas(),IdProducto,"4","3", "3050");
        Consulta3(conexionLagunas(),IdProducto,"4","3", "3050");
        Consulta4(conexionLagunas(),IdProducto,"4","3", "3050");
        Consulta5(conexionLagunas(),IdProducto,"4","3", "3050");
        Consulta6(conexionLagunas(),IdProducto,"4","3", "3050");
        Consulta7(conexionLagunas(),IdProducto,"4","3", "3050");
        Consulta8(conexionLagunas(),IdProducto,"4","3", "3050");
        Consulta9(conexionLagunas(),IdProducto,"4","3", "3050");
        Consulta10(conexionLagunas(),IdProducto,"4","3", "3050");
        Consulta11(conexionLagunas(),IdProducto,"4","3", "3050");
        Consulta12(conexionLagunas(),IdProducto,"4","3", "3050");

    }
    public void ConsultasMatias() {
        consultarIdProducto(conexionLagunas());
        Consulta1(conexionLagunas(),IdProducto,"10","3077", "3078");
        Consulta2(conexionLagunas(),IdProducto,"10","3077", "3078");
        Consulta3(conexionLagunas(),IdProducto,"10","3077", "3078");
        Consulta4(conexionLagunas(),IdProducto,"10","3077", "3078");
        Consulta5(conexionLagunas(),IdProducto,"10","3077", "3078");
        Consulta6(conexionLagunas(),IdProducto,"10","3077", "3078");
        Consulta7(conexionLagunas(),IdProducto,"10","3077", "3078");
        Consulta8(conexionLagunas(),IdProducto,"10","3077", "3078");
        Consulta9(conexionLagunas(),IdProducto,"10","3077", "3078");
        Consulta10(conexionLagunas(),IdProducto,"10","3077", "3078");
        Consulta11(conexionLagunas(),IdProducto,"10","3077", "3078");
        Consulta12(conexionLagunas(),IdProducto,"10","3077", "3078");

    }
    public void ConsultasSD(){
        consultarIdProducto(ConexionSD());
        Consulta1(ConexionSD(),IdProducto,"4","3", "3050");
        Consulta2(ConexionSD(),IdProducto,"4","3", "3050");
        Consulta3(ConexionSD(),IdProducto,"4","3", "3050");
        Consulta4(ConexionSD(),IdProducto,"4","3", "3050");
        Consulta5(ConexionSD(),IdProducto,"4","3", "3050");
        Consulta6(ConexionSD(),IdProducto,"4","3", "3050");
        Consulta7(ConexionSD(),IdProducto,"4","3", "3050");
        Consulta8(ConexionSD(),IdProducto,"4","3", "3050");
        Consulta9(ConexionSD(),IdProducto,"4","3", "3050");
        Consulta10(ConexionSD(),IdProducto,"4","3", "3050");
        Consulta11(ConexionSD(),IdProducto,"4","3", "3050");
        Consulta12(ConexionSD(),IdProducto,"4","3", "3050");
    ...
    public void CustomGraphic(){
        try {
            ...
            lineDataSetDengui = new LineDataSet(dataSet, "Dengui");
